...
Model catalog for [ReActor](https://github.com/KNN-07/ReActor): bundled model database, provider discovery, model identity, classification, and equivalence.
...
Import from subpaths (`@reactor/catalog/<module>`) or the root barrel.
