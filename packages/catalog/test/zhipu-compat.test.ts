...
import { buildOpenAICompat } from "@reactor/catalog/compat/openai";
import { DEFAULT_MODEL_PER_PROVIDER } from "@reactor/catalog/provider-models";
import { zhipuCodingPlanModelManagerOptions } from "@reactor/catalog/provider-models/openai-compat";
import type { FetchImpl, ModelSpec } from "@reactor/catalog/types";
