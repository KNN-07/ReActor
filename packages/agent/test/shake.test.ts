...
import type { SessionEntry, SessionMessageEntry, ShakeConfig } from "@reactor/agent-core/compaction";
import {
...
import type { AssistantMessage, TextContent, ToolCall, ToolResultMessage } from "@reactor/ai";
