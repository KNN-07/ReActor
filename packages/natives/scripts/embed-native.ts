...
const candidates: CandidateAddon[] =
	targetArch === "x64"
		? [
				{ variant: "modern", filename: `reactor_natives.${platformTag}-modern.node` },
				{ variant: "baseline", filename: `reactor_natives.${platformTag}-baseline.node` },
			]
		: [{ variant: "default", filename: `reactor_natives.${platformTag}.node` }];
