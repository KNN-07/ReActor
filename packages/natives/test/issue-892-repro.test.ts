/**
 * Repro for https://github.com/KNN-07/ReActor/issues/892
 *
 ...
 *
 * The contract this test pins down: ESM consumers of `@reactor/natives`
...
describe("issue 892: reactor-natives public surface", () => {
