...
import type { KeyEventType } from "@reactor/natives";
import {
 ...
 * `@mariozechner/tui` `Key` export verbatim so plugins built against any
 * scope alias (`@mariozechner`, `@earendil-works`, `@ReActor`) keep working
