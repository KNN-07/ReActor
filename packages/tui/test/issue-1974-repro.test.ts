...
import { type Component, CURSOR_MARKER, type NativeScrollbackLiveRegion, TUI } from "@reactor/tui";
import { VirtualTerminal } from "./virtual-terminal";

// Regression test for https://github.com/KNN-07/ReActor/issues/1974
//
...
/**
 * Minimal append-only live region. Models the real reactor setup where
...
describe("issue #1974: tmux scrollback rendering", () => {
	...
	it("does not push chrome below the live block into pane history", async () => {
		// Models a real reactor frame: streamed assistant reply on top, persistent
