...
import { type Component, Container, type Focusable, type OverlayFocusOwner, TUI } from "@reactor/tui";
import type { Terminal, TerminalAppearance } from "@reactor/tui/terminal";
