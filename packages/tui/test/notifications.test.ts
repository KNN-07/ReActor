...
describe("terminal notifications", () => {
	...
	it("formats structured Kitty OSC 99 title and body chunks", () => {
		...
		expect(out).toBe(
			"\x1b]99;i=complete-1:f=UmVBY3Rvcg==:a=focus:u=1:t=Y29tcGxldGlvbg==:n=aW5mbw==:s=aW5mbw==:w=5000:d=0;Session\x1b\\" +
	...
	it("base64-encodes unsafe OSC 99 payload controls", () => {
		...
		expect(out).toBe("\x1b]99;i=unsafe:f=UmVBY3Rvcg==:e=1;TGluZSAxCkxpbmUgMg==\x1b\\");
	});
