...
import { LocalProtocolHandler } from "@reactor/coding-agent/internal-urls/local-protocol";
...
import {
	...
	urlHyperlink,
	urlHyperlinkAlways,
} from "@reactor/coding-agent/tui/hyperlink";
import * as terminalCaps from "@reactor/tui";
...
describe("tryResolveInternalUrlSync", () => {
	...
	it("returns undefined for unsupported internal URL schemes", () => {
		...
		expect(tryResolveInternalUrlSync("reactor://docs.md")).toBeUndefined();
	});
