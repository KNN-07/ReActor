...
import { GreenCommand } from "@reactor/coding-agent/extensibility/custom-commands/bundled/ci-green";
...
import type * as TypeBox from "@reactor/coding-agent/extensibility/typebox";
