...
import * as skillsModule from "@reactor/coding-agent/extensibility/skills";
...
import { SKILL_PROMPT_MESSAGE_TYPE } from "@reactor/coding-agent/session/messages";
...
function createSessionResult(session: AgentSession): CreateAgentSessionResult {
	return {
		session,
		extensionsResult:
			{} as unknown as import("@reactor/coding-agent/extensibility/extensions/types").LoadExtensionsResult,
		setToolUIContext: () => {},
