...
import { type AsyncJob, AsyncJobManager } from "@reactor/coding-agent/async/job-manager";
...
import type { AgentDefinition, SingleResult, TaskParams } from "@reactor/coding-agent/task/types";
