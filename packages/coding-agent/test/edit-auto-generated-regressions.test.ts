...
import type { AssistantMessage, StopReason, ToolCall } from "@reactor/ai";
...
import * as autoGeneratedGuard from "@reactor/coding-agent/tools/auto-generated-guard";
...
it("multi-entry edit on an auto-generated file surfaces isError + error text instead of silently faking success", async () => {
	...
	const originalVariant = Bun.env.REACTOR_EDIT_VARIANT;
	Bun.env.REACTOR_EDIT_VARIANT = "patch";
	...
	try {
		...
		if (originalVariant === undefined) {
			...
			Bun.env.REACTOR_EDIT_VARIANT = originalVariant;
		}
	}
});
