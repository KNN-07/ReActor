...
import { applyExtensionFlags, type ExtensionFlagSink } from "@reactor/coding-agent/cli/extension-flags";
...
import { normalizeContinueSessionArgs } from "@reactor/coding-agent/main";
