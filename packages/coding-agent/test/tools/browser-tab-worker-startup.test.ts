...
import type { ReadyInfo, WorkerInbound, WorkerOutbound } from "@reactor/coding-agent/tools/browser/tab-protocol";
import { initializeTabWorkerForTest } from "@reactor/coding-agent/tools/browser/tab-supervisor";
