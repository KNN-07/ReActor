...
import { handleCheatSh } from "@reactor/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@reactor/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@reactor/coding-agent/web/scrapers/tldr";
