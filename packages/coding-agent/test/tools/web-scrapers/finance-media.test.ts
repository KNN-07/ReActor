...
import { handleArtifactHub } from "@reactor/coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@reactor/coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@reactor/coding-agent/web/scrapers/discogs";
