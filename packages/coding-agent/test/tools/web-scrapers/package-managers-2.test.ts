...
import { handleChocolatey } from "@reactor/coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@reactor/coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@reactor/coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@reactor/coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@reactor/coding-agent/web/scrapers/repology";
import { handleTerraform } from "@reactor/coding-agent/web/scrapers/terraform";
