...
import { handleCratesIo } from "@reactor/coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@reactor/coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@reactor/coding-agent/web/scrapers/hex";
import { handleNpm } from "@reactor/coding-agent/web/scrapers/npm";
import { handlePubDev } from "@reactor/coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@reactor/coding-agent/web/scrapers/pypi";
