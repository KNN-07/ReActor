...
import { handleArxiv } from "@reactor/coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@reactor/coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@reactor/coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@reactor/coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@reactor/coding-agent/web/scrapers/types";
