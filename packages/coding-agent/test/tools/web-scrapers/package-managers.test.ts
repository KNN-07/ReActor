...
import { handleAur } from "@reactor/coding-agent/web/scrapers/aur";
import { handleBrew } from "@reactor/coding-agent/web/scrapers/brew";
import { handleMaven } from "@reactor/coding-agent/web/scrapers/maven";
import { handleNuGet } from "@reactor/coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@reactor/coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@reactor/coding-agent/web/scrapers/rubygems";
