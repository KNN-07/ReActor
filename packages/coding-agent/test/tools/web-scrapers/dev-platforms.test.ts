...
import { handleDevTo } from "@reactor/coding-agent/web/scrapers/devto";
import { handleGitLab } from "@reactor/coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@reactor/coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@reactor/coding-agent/web/scrapers/lobsters";
