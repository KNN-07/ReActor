...
import type { SettingPath } from "@reactor/coding-agent/config/settings-schema";
import { IrcBus, type IrcMessage } from "@reactor/coding-agent/irc/bus";
...
import { type CoordinationDetails, HubTool, isIrcEnabled } from "@reactor/coding-agent/tools/hub";
