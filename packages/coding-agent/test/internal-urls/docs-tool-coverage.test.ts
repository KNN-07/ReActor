...
import { BUILTIN_TOOL_NAMES } from "@reactor/coding-agent/tools/builtin-names";

// Every shipped built-in tool that is exposed to the model in normal sessions
// must have a docs/tools/<name>.md root doc served by `reactor://`. File names use
...
describe("reactor:// root docs coverage", () => {
