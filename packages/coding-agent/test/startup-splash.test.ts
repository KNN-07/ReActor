...
import { runStartupSplash } from "@reactor/coding-agent/modes/setup-wizard/startup-splash";
...
import { shouldShowStartupSplash } from "@reactor/coding-agent/startup-splash";
