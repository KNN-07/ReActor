...
import { loadCapability, setDisabledProviders } from "@reactor/coding-agent/capability";
import type { ContextFile } from "@reactor/coding-agent/capability/context-file";
import { clearCache } from "@reactor/coding-agent/capability/fs";
import type { Instruction } from "@reactor/coding-agent/capability/instruction";
import type { Prompt } from "@reactor/coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@reactor/coding-agent/capability/rule";
import { RuleProtocolHandler } from "@reactor/coding-agent/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@reactor/utils";
import "@reactor/coding-agent/capability/context-file";
import "@reactor/coding-agent/capability/instruction";
import "@reactor/coding-agent/capability/prompt";
import "@reactor/coding-agent/capability/rule";
import "@reactor/coding-agent/discovery/github";
