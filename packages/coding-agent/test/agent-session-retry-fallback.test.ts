...
import { type AssistantMessage, Effort, type Model, type ProviderSessionState } from "@reactor/ai";
...
import { parseModelPattern, parseModelString } from "@reactor/coding-agent/config/model-resolver";
