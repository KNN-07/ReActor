...
import { resolveThresholdTokens, shouldCompact } from "@reactor/agent-core/compaction";
...
import type { CompactionEntry } from "@reactor/coding-agent/session/session-entries";
