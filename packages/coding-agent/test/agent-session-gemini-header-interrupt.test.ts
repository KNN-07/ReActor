...
import type { Api, AssistantMessage, Context, Message, Model, SimpleStreamOptions, ThinkingContent } from "@reactor/ai";
...
import { GEMINI_HEADER_RUNAWAY_THRESHOLD } from "@reactor/ai/utils/thinking-loop";
