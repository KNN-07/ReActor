...
import { completionBudgetReport, GoalRuntime } from "@reactor/coding-agent/goals/runtime";
import type { Goal, GoalModeState, GoalTokenUsage } from "@reactor/coding-agent/goals/state";
import { GoalTool } from "@reactor/coding-agent/goals/tools/goal-tool";
