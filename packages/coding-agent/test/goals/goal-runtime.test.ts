...
} from "@reactor/coding-agent/goals/runtime";
import type { Goal, GoalModeState, GoalRuntimeEvent, GoalTokenUsage } from "@reactor/coding-agent/goals/state";
import { escapeXmlText } from "@reactor/utils";
