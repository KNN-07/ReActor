...
import { Agent, isSoftToolRequirement } from "@reactor/agent-core";
...
import { dispatchResolutionDevice, queueResolveHandler } from "@reactor/coding-agent/tools/resolve";
import { buildNamedToolChoice } from "@reactor/coding-agent/utils/tool-choice";
