...
import type { AssistantThinkingRenderer } from "@reactor/coding-agent/extensibility/extensions";
import { AssistantMessageComponent } from "@reactor/coding-agent/modes/components/assistant-message";
import { clearMermaidCache } from "@reactor/coding-agent/modes/theme/mermaid-cache";
import { initTheme } from "@reactor/coding-agent/modes/theme/theme";
import { ImageProtocol, setTerminalImageProtocol, TERMINAL, Text } from "@reactor/tui";
