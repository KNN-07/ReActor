...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@reactor/coding-agent/capability/rule";
import { bucketRules } from "@reactor/coding-agent/capability/rule-buckets";
