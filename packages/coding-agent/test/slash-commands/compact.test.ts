...
import type { CompactOptions } from "@reactor/coding-agent/extensibility/extensions/types";
import type { InteractiveModeContext } from "@reactor/coding-agent/modes/types";
import type { CompactMode } from "@reactor/coding-agent/session/compact-modes";
import {
	ACP_BUILTIN_SLASH_COMMANDS,
	executeAcpBuiltinSlashCommand,
} from "@reactor/coding-agent/slash-commands/acp-builtins";
import { executeBuiltinSlashCommand } from "@reactor/coding-agent/slash-commands/builtin-registry";
import type { SlashCommandRuntime } from "@reactor/coding-agent/slash-commands/types";
