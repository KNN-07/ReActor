...
import type { MarketplacePluginEntry } from "@reactor/coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@reactor/coding-agent/extensibility/plugins/marketplace";
...
describe("resolvePluginSource", () => {
	...
	beforeEach(() => {
		tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "reactor-src-res-test-"));
	});
