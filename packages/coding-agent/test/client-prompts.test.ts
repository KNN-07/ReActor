...
import { getPrompt, listPrompts, serverSupportsPrompts } from "@reactor/coding-agent/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "@reactor/coding-agent/mcp/types";
