...
import type { AssistantMessage, Context, Message } from "@reactor/ai";
import {
	...
	SecretObfuscator,
} from "@reactor/coding-agent/secrets/obfuscator";
import { compileSecretRegex } from "@reactor/coding-agent/secrets/regex";
