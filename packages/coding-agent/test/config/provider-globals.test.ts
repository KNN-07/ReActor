...
import { applyProviderGlobalsFromSettings } from "@reactor/coding-agent/config/provider-globals";
import * as imageGen from "@reactor/coding-agent/tools/image-gen";
import * as webSearch from "@reactor/coding-agent/web/search";
