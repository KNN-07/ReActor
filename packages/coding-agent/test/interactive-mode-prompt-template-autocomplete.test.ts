/**
 * Issue #2462: prompt templates discovered from `cwd/.reactor/prompts/` were never
...
import type { PromptTemplate } from "@reactor/coding-agent/config/prompt-templates";
