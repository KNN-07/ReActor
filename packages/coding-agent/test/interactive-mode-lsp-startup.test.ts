...
import { LSP_STARTUP_EVENT_CHANNEL, type LspStartupEvent } from "@reactor/coding-agent/lsp/startup-events";
...
import type { LspStartupServerInfo } from "@reactor/coding-agent/tools";
