 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@reactor/coding-agent";

// Discover all skills from cwd/.reactor/skills, ~/.reactor/agent/skills, etc.
