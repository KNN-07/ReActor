 ...
 * - ~/.reactor/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.reactor/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.reactor/agent/extensions/ or .reactor/extensions/
