 ...
 *
 * Usage:
 *   reactor --hook examples/hooks/custom-compaction.ts
 */
import { complete, getModel } from "@reactor/ai";
import type { HookAPI } from "@reactor/coding-agent";
import { convertToLlm, serializeConversation } from "@reactor/coding-agent";
