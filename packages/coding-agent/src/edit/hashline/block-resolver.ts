 ...
 * primitive in `@reactor/natives`, which infers the language from the file
 ...
 */
import type { BlockResolver } from "@reactor/hashline";
import { blockRangeAt } from "@reactor/natives";
