 ...
 *
 * Dependencies (the zod-backed typebox shim and coding-agent) are injected via the
 ...
 * `.reactor/tools/`, `.claude/tools/`, the plugin tree, and any configured paths.
 *
...
export async function discoverCustomToolPaths(configuredPaths: string[], cwd: string): Promise<ToolPathWithSource[]> {
	...
	// 2. Plugin tools: ~/.reactor/plugins/node_modules/*/
 ...
 * 2. Installed plugins (~/.reactor/plugins/node_modules/*)
