...
import { getProjectDir, prompt } from "@reactor/utils";
import {
...
export async function loadSkills(options: LoadSkillsOptions = {}): Promise<LoadSkillsResult> {
	...
	// third-party toggles count here: the ReActor-native providers (`agents`,
	...
	function isSourceEnabled(source: SourceMeta): boolean {
		...
		// Managed skills (auto-learn) are ReActor-native and discovered unconditionally
