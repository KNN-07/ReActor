...
/**
 * Plugin manifest from package.json reactor or pi field.
 */
...
// =============================================================================
// Runtime Config Types (stored in reactor-plugins.lock.json)
// =============================================================================
...
/**
 * Runtime configuration persisted to reactor-plugins.lock.json.
...
/**
 * Project-local plugin overrides (stored in .reactor/plugin-overrides.json).
