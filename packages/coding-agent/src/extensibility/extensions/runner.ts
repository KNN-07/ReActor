...
import type { CredentialDisabledEvent, ImageContent, Model, ProviderResponseMetadata } from "@reactor/ai";
...
export class ExtensionRunner {
	...
	initialize(
		...
		// spread adds the `type` discriminator — `event` is the ai shape (no `type`).
