 ...
 * `@reactor/utils` (or anything that transitively does). That package's
 ...
 * runtime imports from `@reactor/utils`, which is the whole reason it can
 ...
 */
export const PROFILE_BOOTSTRAP_BOUNDARY_ARG = "--reactor-profile-boundary";
 ...
 * argument — `reactor --print --profile work` still selects a profile) apart from an
 ...
 * a flag's value instead of mistaking it for the subcommand — `reactor --model acp`
