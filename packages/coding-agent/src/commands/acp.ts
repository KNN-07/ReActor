/**
 * Run ReActor as an ACP (Agent Client Protocol) server over stdio.
 *
 ...
 */
import { Command } from "@reactor/utils/cli";
...
export default class Acp extends Command {
	static description = "Run ReActor as an ACP (Agent Client Protocol) server over stdio";
	static strict = false;
