...
export default class Grievances extends Command {
	...
	static args = {
		...
		// arg keeps the historical `reactor grievances` invocation working unchanged
	...
	static examples = [
		"reactor grievances",
		"reactor grievances list --tool find",
		"reactor grievances clean --id 209",
		"reactor grievances clean --tool find",
		"reactor grievances clean --all",
		"reactor grievances push",
	];
