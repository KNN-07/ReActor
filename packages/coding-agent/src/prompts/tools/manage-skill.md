Create, update, or delete a managed skill — a `SKILL.md` written to an isolated directory (`~/.reactor/agent/managed-skills`) and surfaced like a normal skill in future sessions.
