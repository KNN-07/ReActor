import { logger, toError } from "@reactor/utils";
import {
...
export interface RedisSessionStorageOptions {
	...
	/**
	 * Key prefix applied to every Redis key this storage owns. Default `reactor:sessions:`.
...
const DEFAULT_PREFIX = "reactor:sessions:";
