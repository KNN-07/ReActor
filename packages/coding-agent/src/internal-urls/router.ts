/**
 * Internal URL router for internal protocols (`agent://`, `artifact://`, `history://`, `issue://`, `local://`, `mcp://`, `memory://`, `reactor://`, `pr://`, `rule://`, `skill://`, `ssh://`, `vault://`, and `xd://`).
 *
...
import { ReactorProtocolHandler } from "./reactor-protocol";
...
export class InternalUrlRouter {
	...
	constructor() {
		this.register(new ReactorProtocolHandler());
