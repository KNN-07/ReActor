...
import { $env, $which, getPythonEnvDir } from "@reactor/utils";
...
const DEFAULT_ENV_ALLOW_PREFIXES = ["LC_", "XDG_", "REACTOR_"];
 ...
 * the managed `~/.reactor/python-env`, then the system interpreter on PATH. Every
