    (function() {
      ...
      //  - Share viewer: share-loader.js sets `window.__REACTOR_SESSION_DATA__` to
      ...
      // ============================================================
      //
      // Tool calls render through the bundled <reactor-tool-view> web component
      ...
      globalThis.__REACTOR_TOOL_VIEW_DATA = TOOL_VIEW_DATA;
      let toolViewSeq = 0;
      ...
      function renderToolCall(call, sctx) {
        ...
        return '<reactor-tool-view class="tool-execution ' + statusClass + '" data-key="' + key + '" open></reactor-tool-view>';
      }
      ...
      const pending = window.__REACTOR_SESSION_DATA__;
