...
import { convertTools } from "@reactor/ai/providers/google-shared";
import type { Model, TJsonSchema, Tool } from "@reactor/ai/types";
import { normalizeSchemaForCCA, normalizeSchemaForGoogle } from "@reactor/ai/utils/schema";
