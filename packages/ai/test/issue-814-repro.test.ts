...
import type { AssistantMessage, Model, ModelSpec, ToolResultMessage, UserMessage } from "@reactor/ai/types";
 ...
 * carries `tool_use_id`. As a workaround, ReActor must include `id` (aliased to
