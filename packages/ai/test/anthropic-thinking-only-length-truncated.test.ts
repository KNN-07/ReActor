...
import type { AssistantMessage, Message, Model, UserMessage } from "@reactor/ai/types";
 ...
 *
 * Reproduces the shape captured in `~/.reactor/logs/http-400-requests/*.json` after Claude
