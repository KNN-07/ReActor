 ...
 * that powers `reactor auth-gateway check`. Contract under test:
 *
...
} from "@reactor/ai/auth-storage";
import type { UsageProvider } from "@reactor/ai/usage";
import * as claudeUsage from "@reactor/ai/usage/claude";
import { opencodeGoUsageProvider } from "@reactor/ai/usage/opencode-go";
