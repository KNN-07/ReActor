/**
 * Test helper for resolving API keys from ~/.reactor/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@reactor/ai/oauth";
import type { OAuthCredentials, OAuthProvider } from "@reactor/ai/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@reactor/utils";
...
/**
 * Resolve API key for a provider from ~/.reactor/agent/testauth.db
 *
