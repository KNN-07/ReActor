...
import type { Api, Context, Model, ModelSpec } from "@reactor/ai/types";
import { buildModel } from "@reactor/catalog/build";
import { COPILOT_API_HEADERS } from "@reactor/catalog/wire/github-copilot";
 ...
 * hint (an ReActor extension that preserves native-resolution snapcompact
