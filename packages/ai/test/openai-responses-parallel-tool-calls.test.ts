// Regression for https://github.com/KNN-07/ReActor/issues/1880.
//
...
import type { ResponseStreamEvent } from "@reactor/ai/providers/openai-responses-wire";
import { processResponsesStream } from "@reactor/ai/providers/openai-shared";
import type { AssistantMessage, Model } from "@reactor/ai/types";
