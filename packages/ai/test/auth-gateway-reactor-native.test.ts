...
import { encodeStream, formatError, parseRequest } from "@reactor/ai/providers/reactor-native-server";
import type {
	AssistantMessage,
...
describe("reactor-native parseRequest", () => {
...
describe("reactor-native encodeStream", () => {
	it("ships every AssistantMessageEvent verbatim, terminated by [DONE]", async () => {
		// Pi-native is reactor-talks-to-reactor: the client feeds parsed events directly
...
describe("reactor-native formatError", () => {
