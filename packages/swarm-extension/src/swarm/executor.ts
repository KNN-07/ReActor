/**
 * Swarm agent execution via ReActor's subagent infrastructure.
 *
...
import { runSubprocess } from "@reactor/coding-agent";
...
/**
 * Execute a single swarm agent as an ReActor subagent.
 *
 * The agent receives:
