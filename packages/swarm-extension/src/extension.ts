 ...
 * then use /swarm in any ReActor session.
 */

import * as fs from "node:fs/promises";
import * as path from "node:path";
import type { ExtensionAPI, ExtensionCommandContext } from "@reactor/coding-agent";
import { formatDuration } from "@reactor/utils";
