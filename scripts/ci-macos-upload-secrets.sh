...
# terminal transcript.
#
# Prepare a directory (default ~/reactor-signing) containing:
...
#   REACTOR_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/reactor-signing
...
DIR="${DIR:-${REACTOR_SIGNING_DIR:-$HOME/reactor-signing}}"
REPO="${REACTOR_REPO:-KNN-07/ReActor}"
