 ...
 *
 * The heavy coding-agent import lives here; probe.ts stays ai-only.
 */
import { parseArgs } from "node:util";
import { toolWireSchema } from "@reactor/ai";
import { Settings } from "@reactor/coding-agent/config/settings";
import { BUILTIN_TOOLS, GithubTool, HIDDEN_TOOLS, IrcTool, type Tool, type ToolFactory, type ToolSession } from "@reactor/coding-agent/tools";
