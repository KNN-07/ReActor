...
// Inline nav glyphs — reactor_worker has no icon library.
    ...
    <aside class="rmp-rail">
      ...
      <div class="rmp-rail-brand">
        ...
        <span class="rmp-rail-wordmark">
          <span class="rmp-rail-name">reactor_worker</span>
      ...
      <nav class="rmp-nav">
        {NAV.map((item) => (
          <button
            ...
            title={item.locked ? "Triage — locked (set REACTOR_WORKER_REPLAY_TOKEN to enable)" : item.label}
