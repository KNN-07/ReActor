...
Shared by the `reactor_worker triage` CLI and the dashboard's POST /api/trigger.
"""
...
from reactor_worker.db import INACTIVE_EVENT_STATES, Database, EventRow, issue_key
