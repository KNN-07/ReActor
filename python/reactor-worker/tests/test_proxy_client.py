...
from reactor_worker.git_ops import HeadDriftError
...
async def test_round_trip_all_endpoints(round_trip_app) -> None:
    ...
    assert await client.get_authenticated_login() == "reactor_worker-bot"
    ...
    assert existing_pr.author == "reactor_worker-bot"
