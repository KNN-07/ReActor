...
impl From<reactor_ast::summary::SummarySegment> for SummarySegment {
	fn from(value: reactor_ast::summary::SummarySegment) -> Self {
		Self {
			kind:       value.kind,
...
impl From<reactor_ast::summary::SummaryResult> for SummaryResult {
	fn from(value: reactor_ast::summary::SummaryResult) -> Self {
		Self {
...
pub fn summarize_code(options: SummaryOptions) -> Result<SummaryResult> {
	reactor_ast::summary::summarize_code(reactor_ast::summary::SummaryOptions {
		code:               options.code,
		lang:               options.lang,
		path:               options.path,
