...
Render writes use synchronized output mode (`CSI ? 2026 h/l`) when enabled; capability detection, DECRQM, or `REACTOR_NO_SYNC_OUTPUT` can disable the wrappers while leaving autowrap discipline on.
