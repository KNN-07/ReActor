...
## Side Effects
- Filesystem: writes or deletes files under `~/.reactor/agent/managed-skills`.
- Network: none.
...
## Notes
- Managed skills are generated under `~/.reactor/agent/managed-skills` and never edit user-authored skills.
