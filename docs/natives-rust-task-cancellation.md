# Native Rust task execution and cancellation (`reactor-natives`)

This document describes how `crates/reactor-natives` schedules native work and how cancellation flows from JS options (`timeoutMs`, `AbortSignal`) into Rust execution.

## Implementation files

- `crates/reactor-natives/src/task.rs`
- `crates/reactor-natives/src/grep.rs`
- `crates/reactor-natives/src/glob.rs`
- `crates/reactor-natives/src/fd.rs`
- `crates/reactor-natives/src/ast.rs`
- `crates/reactor-natives/src/workspace.rs`
- `crates/reactor-natives/src/shell.rs`
- `crates/reactor-natives/src/pty.rs`
- `crates/reactor-natives/src/html.rs`
- `crates/reactor-natives/src/sixel.rs`
- `crates/reactor-natives/src/clipboard.rs`
- `crates/reactor-natives/src/text.rs`
...
| `Shell#run(options, onChunk?)`          | `Shell::run`                | `task::future(env, "shell.run", ...)`                          | JS `CancelToken` is converted into `reactor_shell::cancel::CancelToken`; shell races it against command completion and descendant cleanup |
