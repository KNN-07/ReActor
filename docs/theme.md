...
- syntax highlighting colors used by native highlighter (`@reactor/natives`)
...
- default: `~/.reactor/agent/themes`
- overridden by `REACTOR_CODING_AGENT_DIR` (`$REACTOR_CODING_AGENT_DIR/themes`)
...
- default agent dir: `~/.reactor/agent`
- effective default file: `~/.reactor/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.reactor/agent/themes/my-theme.json`.
